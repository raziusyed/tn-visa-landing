...
export default function MailinglistForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="rounded-lg border bg-card p-6 text-center shadow-lg">
        ...
        <h3 className="text-xl font-medium">Awesome, You're in!</h3>
        <p className="mt-2 text-muted-foreground">
          Please check your email for a confirmation - it may take a few minutes
          to arrive. If you don't see it, please check your junk folder.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        {isSubmitting ? "You're on your way..." : "Join"}
      </Button>
